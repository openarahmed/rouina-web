...
export default function BlogPostDisplay({ post, recentPosts }: { post: BlogPost, recentPosts: BlogPost[] }) {
    const postUrl = `https://your-site.com/blogs/${post.slug}`;

    return (
        <section className="bg-[#0D0915] text-white">
            {/* ★★★ 1. New Blog Post Header Section ★★★ */}
            {post.imageUrl && (
            ...
            <div className="py-12 sm:py-16">
                <div className="container mx-auto px-4">
                    <article className="max-w-3xl mx-auto">
                        ...
                        <div className="prose prose-invert prose-lg lg:prose-xl max-w-none text-slate-300 leading-relaxed whitespace-pre-wrap">
                            {post.content}
                        </div>
            ...
            {/* "Recent Posts" section remains at the bottom */}
                            ...
                            <div key={recentPost.id} className="group">
                                <Link href={`/blogs/${recentPost.slug}`} className="block mb-4">
                                    {recentPost.imageUrl ? (
                                        ...
                                        <div className="w-full h-auto aspect-[4/3] bg-[#2E284D] flex items-center justify-center rounded-xl">...</div>
                                    )}
                                </Link>
